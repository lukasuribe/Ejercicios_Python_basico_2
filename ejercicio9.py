...
for campaña in lista_campañas:
    if "duracion_dias" not in campaña:
        inicio = datetime.strptime(campaña["inicio"], "%Y-%m-%d")
        fin = datetime.strptime(campaña["fin"], "%Y-%m-%d")
...
print("La campaña más larga es:", campaña_mas_larga)

...
for campaña in lista_campañas:
    try:
        conversion = campaña['presupuesto'] / int(campaña['personas_alcanzadas'])
    except ZeroDivisionError:
        print(f"Error: División entre 0 en la campaña {campaña['nombre']}")
    except ValueError:
        print(f"Error: Valor no válido para personas alcanzadas en la campaña {campaña['nombre']}")
